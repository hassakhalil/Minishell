...
#    Updated: 2022/10/15 04:33:26 by hkhalil          ###   ########.fr        #
#                                                                              #
# **************************************************************************** #

NAME = minishell

SRC	= cd.c echo.c exit.c exec.c redir.c pipe.c utils/env_utils.c builtin.c clean.c errors.c quote_remover.c expander.c executor.c main.c lexer.c parser.c path.c\
