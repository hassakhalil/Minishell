...
#    Updated: 2022/10/15 20:50:25 by hkhalil          ###   ########.fr        #
#                                                                              #
# **************************************************************************** #

NAME = minishell

SRC	= parent_builtin.c export.c unset.c env.c pwd.c cd.c echo.c exit.c exec.c redir.c pipe.c utils/env_utils.c child_builtin.c clean.c errors.c quote_remover.c expander.c executor.c main.c lexer.c parser.c path.c\
